...
- `docs/leaderboard.md` — HUD **bot leaderboard** modal: per-bot name/role/charge/health rows ranked by charge, plus aggregate alive/broken/discharged counts and percentages.
