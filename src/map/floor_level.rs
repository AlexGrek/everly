...
/// Inclusive highest floor index (`0..=HYPERMAP_FLOOR_MAX`). Signed so it
/// shares the unified `i32` coordinate space with everything else in `map/`.
pub const HYPERMAP_FLOOR_MAX: i32 = 9;
...
pub struct ActiveFloorLevel(pub i32);
