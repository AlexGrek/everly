...
use super::types::{SUBSEED_ROOM_RADIUS_MAX, SUBSEED_ROOM_RADIUS_MIN};
...
impl Room {
    fn from_center_growth(
        ...
        let rx = rng::range(rng, SUBSEED_ROOM_RADIUS_MIN..=SUBSEED_ROOM_RADIUS_MAX);
        let rz = rng::range(rng, SUBSEED_ROOM_RADIUS_MIN..=SUBSEED_ROOM_RADIUS_MAX);
